        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingGovernorateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShippingGovernorateName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_ShippingGovernorates_ShippingGovernorateId",
                        column: x => x.ShippingGovernorateId,
                        principalSchema: "dbo",
                        principalTable: "ShippingGovernorates",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_ShippingGovernorateId",
                schema: "dbo",
                table: "Orders",
                column: "ShippingGovernorateId");
