...
{
    public class CreateBrandReviewCommandValidator : AbstractValidator<CreateBrandReviewCommand>
    {
        public CreateBrandReviewCommandValidator(IStringLocalizer<Messages> localizer)
        {
            RuleFor(v => v.Rating)
