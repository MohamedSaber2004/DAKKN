...
{
    public class GetAdminTicketDetailsQueryHandler : IRequestHandler<GetAdminTicketDetailsQuery, SupportTicketDetailsDto>
    {
        private readonly IUnitOfWork _unitOfWork;

        public GetAdminTicketDetailsQueryHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public async Task<SupportTicketDetailsDto> Handle(GetAdminTicketDetailsQuery request, CancellationToken ct)
        {
