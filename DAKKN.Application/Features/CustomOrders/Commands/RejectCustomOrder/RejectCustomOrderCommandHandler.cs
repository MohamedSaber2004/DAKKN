...
{
    public class RejectCustomOrderCommandHandler : IRequestHandler<RejectCustomOrderCommand, bool>
    {
        private readonly IUnitOfWork _unitOfWork;
        private readonly ICurrentUserService _currentUser;
        private readonly IStringLocalizer<Messages> _localizer;

        public RejectCustomOrderCommandHandler(
        ...
        public async Task<bool> Handle(RejectCustomOrderCommand request, CancellationToken cancellationToken)
        {
